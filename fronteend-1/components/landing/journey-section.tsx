...
const steps = [
  {
    number: "01",
    title: "Discover",
    subtitle: "your Prakriti",
    description: "Share your symptoms, concerns, and lifestyle. Our AI guides you through a traditional Ayurvedic assessment to understand your unique constitution.",
    code: `// Your Prakriti Assessment
{
  dosha: 'Vata-Pitta',
  agni: 'Vishama (Variable)',
  season: 'Sharad Ritu',
  imbalance: 'Vata vitiation'
}`,
  },
  {
    number: "02",
    title: "Receive",
    subtitle: "sacred guidance",
    description: "Access personalized recommendations drawn from authentic Ayurvedic texts. Herbs, diet, yoga, and lifestyle practices aligned with your nature.",
    code: `// Personalized Recommendations
{
  herbs: ['Ashwagandha', 'Brahmi'],
  diet: 'Vata-pacifying foods',
  routine: 'Abhyanga (oil massage)',
  yoga: 'Gentle, grounding asanas'
}`,
  },
  {
    number: "03",
    ...
    description: "Follow your personalized path to balance. Track your progress and receive ongoing guidance as you journey toward holistic wellbeing.",
    code: `// Your Wellness Journey
{
  balance: 'Improving',
  practices: ['Dinacharya', 'Pranayama'],
  progress: 'Dosha harmony restored'
}
// Namaste, your healing continues`,
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Balance.</span>
