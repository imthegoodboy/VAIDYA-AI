...
const regions = [
  ...
  { name: "Sushruta Samhita", nodes: 186, status: "indexed" },
  { name: "Ashtanga Hridaya", nodes: 120, status: "indexed" },
  { name: "Bhavaprakasha", nodes: 80, status: "indexed" },
];
...
export function TraditionsSection() {
  ...
  return (
    <section id="traditions" ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                ...
                Our knowledge base draws from the most revered Ayurvedic scriptures.
                Authentic wisdom from 5000+ years of healing tradition.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-8xl lg:text-[10rem] font-display leading-none">108</span>
                <span className="text-2xl text-muted-foreground">sacred texts</span>
              </div>
              <p className="text-muted-foreground max-w-md">
                Ancient scriptures indexed and analyzed for authentic Ayurvedic knowledge.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-100 ${
              ...
              <span className="block text-sm text-muted-foreground mt-2">Years of tradition</span>
            </div>
            
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}>
              <span className="text-5xl lg:text-6xl font-display">500+</span>
              <span className="block text-sm text-muted-foreground mt-2">Herbs documented</span>
            </div>
          </div>
        </div>
        ...
        <div className={`mt-12 grid grid-cols-2 lg:grid-cols-4 gap-4 transition-all duration-1000 delay-300 ${
          ...
          {regions.map((region, index) => (
            ...
            >
              ...
              <span className="text-sm text-muted-foreground">{region.nodes} chapters</span>
            </div>
          ))}
        </div>
      </div>
